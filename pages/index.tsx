        ...
        <div className={styles.xPadding}>
          <div className={styles.textAndBtn}>
            <div className={styles.text}>
              <h5 className={`${styles.heading5} ${barlowCondensed.className}`}>
                So, you want to travel to
              </h5>
              <h1 className={`${styles.heading1Extended} ${bellefair.className}`}>
                Space
              </h1>
              <p className={styles.bodyTextExtended + ' ' + barlow.className}>
